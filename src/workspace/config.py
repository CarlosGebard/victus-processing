...
DATA_DEBUG_RUNS_DIR = DATA_DEBUG_DIR / "runs"
...
DATA_LAKE_EXPERIMENT_PACKETS_FILE = DATA_LAKE_DIR / "experiment_packets.jsonl"
DATA_LAKE_CANONICAL_EVIDENCE_FILE = DATA_LAKE_DIR / "canonical_evidence.jsonl"
DATA_LAKE_PIPELINE_RUNS_FILE = DATA_LAKE_DIR / "pipeline_runs.jsonl"
DATA_LAKE_PIPELINE_EVENTS_FILE = DATA_LAKE_DIR / "pipeline_events.jsonl"
DATA_LAKE_PAPER_STAGE_STATE_FILE = DATA_LAKE_DIR / "paper_stage_state.jsonl"
DATA_REGISTRY_ARTIFACT_MANIFEST_FILE = DATA_REGISTRY_DIR / "artifact_manifest.jsonl"
DATA_REGISTRY_ARTIFACT_REGISTRY_FILE = DATA_REGISTRY_DIR / "artifact_registry.jsonl"
DATA_REGISTRY_DOCUMENTS_FILE = DATA_REGISTRY_DIR / "documents.jsonl"
DATA_REGISTRY_LINKS_FILE = DATA_REGISTRY_DIR / "links.jsonl"
DATA_RUNTIME_OUTBOX_DIR = DATA_RUNTIME_DIR / "outbox"
DATA_RUNTIME_POSTGRES_OUTBOX_FILE = DATA_RUNTIME_OUTBOX_DIR / "postgres_pipeline_records.jsonl"
...
VICTUS_PIPELINE_POSTGRES_ENABLED = (
    get_env_or_config("VICTUS_PIPELINE_POSTGRES_ENABLED", "pipeline", "postgres_enabled", default="false")
    or "false"
).lower() in {"1", "true", "yes", "on"}
VICTUS_PIPELINE_POSTGRES_DSN = get_env_or_config("VICTUS_PIPELINE_POSTGRES_DSN", "pipeline", "postgres_dsn", default="")
