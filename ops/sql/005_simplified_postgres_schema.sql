...
DROP TABLE IF EXISTS general_evidence_support;
DROP TABLE IF EXISTS general_evidence;
DROP TABLE IF EXISTS evidence_projections;
DROP TABLE IF EXISTS outcome_registry;
...
CREATE INDEX idx_evidence_projections_build_id ON evidence_projections(build_id);
CREATE INDEX idx_evidence_projections_canonical_id ON evidence_projections(canonical_evidence_id);
CREATE INDEX idx_evidence_projections_paper_id ON evidence_projections(paper_id);
CREATE INDEX idx_evidence_projections_pair ON evidence_projections(exposure_id, outcome_id);
CREATE INDEX idx_evidence_projections_rank ON evidence_projections(evidence_rank);

CREATE TABLE general_evidence (
...
CREATE INDEX idx_general_evidence_build_id ON general_evidence(build_id);
CREATE INDEX idx_general_evidence_pair ON general_evidence(exposure_id, outcome_id);
CREATE INDEX idx_general_evidence_status ON general_evidence(status);
CREATE INDEX idx_general_evidence_consensus ON general_evidence(consensus_level);

CREATE TABLE general_evidence_support (
...
CREATE INDEX idx_general_evidence_support_projection
